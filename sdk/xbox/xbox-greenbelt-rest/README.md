# Azure XboxGreenbelt REST client library for JavaScript
...
### Install the `@azure-rest/xbox-greenbelt` package

Install the Azure XboxGreenbelt REST client REST client library for JavaScript with `npm`:

```bash
npm install @azure-rest/xbox-greenbelt
```

### Create and authenticate a `GreenbeltSDKClient`
